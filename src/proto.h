...
void init_multiplayer_mode(void);
...
// Multiplayer: Player 2 input functions
void read_user_control_p2(void);
void read_keyb_control_p2(void);
void read_joyst_control_p2(void);
void user_control_p2(void);
int can_grab(void);
