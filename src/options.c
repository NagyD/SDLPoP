...
const char scaling_type_names[][MAX_OPTION_VALUE_NAME_LENGTH] = {"sharp", "fuzzy", "blurry"};
names_list_type scaling_type_names_list = {&scaling_type_names, COUNT(scaling_type_names)};
