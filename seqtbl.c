...
const byte seqtbl[] = {
        ...
        act(actions_1_run_jump), frame_1_start_run,
        ...
        dx(4), frame_11_run,
        dx(5), frame_12_run,
        dx(2), snd(SND_FOOTSTEP), frame_13_run,
        dx(3), frame_14_run,
        dx(4), jmp(runcyc1),
        ...
        LABEL(alertstand) // alert stand
        act(actions_1_run_jump), /* ":loop" */ frame_166_stand_inactive,
        jmp(0x19A8), // goto ":loop"
        ...
        act(actions_1_run_jump), frame_151_strike_1,
        /* "guy4" */ act(actions_1_run_jump), frame_152_strike_2,
        frame_153_strike_3,
        frame_154_poking,
        /* "guy7" */ act(actions_5_bumped), frame_155_guy_7,
        /* "guy8" */ act(actions_1_run_jump), frame_156_guy_8,
        frame_157_walk_with_sword,
        jmp(ready), // goto "ready"

        // blocked strike
        act(actions_1_run_jump), frame_167_blocked,
        jmp(0x1A4A), // goto "guy7"

        // block to strike
        // "blocktostrike"
        frame_162_block_to_strike,
        jmp(0x1A45), // goto "guy4"
        ...
        // flee
        act(actions_7_turn), dx(-8), jmp(0x1B39), // goto "turn"

        // turn en garde
        act(actions_5_bumped), SEQ_FLIP, dx(5), jmp(0x1A2E), // goto "retreat"
        ...
        dx(5), dy(-6), /* "sjland" */ frame_25_standing_jump_10,
        ...
        dx(4), dy(3), /* "rjlandrun" */ frame_44_running_jump_5,
        ...
        dx(2), frame_109_crouch,
        dx(2), /* ":crouch" */frame_109_crouch,
        jmp(0x1B16), // goto ":crouch"
        ...
        act(actions_1_run_jump), dx(-1), jmp(0x1975), // goto "runstt1"
        ...
        dx(-14), SEQ_FLIP, jmp(0x1995), // goto "runcyc7"
